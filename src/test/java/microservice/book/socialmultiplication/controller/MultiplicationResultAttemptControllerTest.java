...
import microservice.book.socialmultiplication.controller.MultiplicationResultAttemptController.ResultResponse;
...
public class MultiplicationResultAttemptControllerTest {
	...
	private MockMvc mvc;
	@Autowired
	private MultiplicationResultAttemptController controller; 
		...
		given(multiplicationService.checkAttempt(any(MultiplicationResultAttempt.class))).willReturn(correct);
		  User user = new User("john");
	        ...
	        assertThat(response.getContentAsString()).isEqualTo(
	                jsonResponse.write(controller.new ResultResponse(correct, 3500)).getJson());
